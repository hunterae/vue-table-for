...
// CONCATENATED MODULE: ./src/components/TableDataColumn.js


/* harmony default export */ var TableDataColumn = ({
  props: {
    record: {
  ...
  computed: {
    formattedContent: function formattedContent() {
      ...
      if (typeof formattedContent === 'undefined' && this.record.hasOwnProperty(this.field)) {
  ...
  render: function render(createElement) {
    var element;
    var customContent = this.$slots.default;
    var content = this.formattedContent;

    if (customContent) {
      element = createElement('td', {}, customContent);
    } else if (_typeof(content) === 'object' && content.hasOwnProperty('tag')) {
...
// CONCATENATED MODULE: ./src/components/TableHeaderColumn.js


/* harmony default export */ var TableHeaderColumn = ({
  props: {
    name: {
      type: String,
      required: true
    ...
    content: {
      default: function _default() {
        return startCase_default()(this.name);
      }
    },
    formatter: {
      type: Function
  ...
  render: function render(createElement) {
    var content = this.$slots.default || [this.formattedContent];
...
// CONCATENATED MODULE: ./src/components/TableFor.js
...
/* harmony default export */ var TableFor = ({
  components: {
  ...
  methods: {
    ...
    renderFirstSlotOrChildrenWithHooks: function renderFirstSlotOrChildrenWithHooks() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          _ref$slotName = _ref.slotName,
          slotName = _ref$slotName === void 0 ? null : _ref$slotName;
      ...
      if (slots) {
        var slot = slots[0];
        return this.$createElement(slot.tag, es(data, slot.data), slot.children); // return this.$createElement(RenderWithHooks, deepMerge(slot.data || {}, { props: { suffix: `_${slotName}`, tag: slot.tag, wrapper: wrapper } }), slot.children)
      } else {
        return this.$createElement(tag, data, children); // return this.$createElement(RenderWithHooks, { props: { suffix: `_${slotName}`, tag: tag, wrapper: wrapper } }, children)
      }
    },
    createHeaderColumn: function createHeaderColumn(column) {
      if (column.tag === 'td') {
        var columnName = column.data.attrs.name;
        ...
        var headerOptions = {
          props: _objectSpread({
            name: columnName
          }, pick_default()(header, Object.keys(TableHeaderColumn.props))),
          attrs: omit_default()(header, Object.keys(TableHeaderColumn.props))
        };
        ...
        if (column.data.attrs.hasOwnProperty('header')) {
          ...
          if (_typeof(header) === 'object') {
            headerOptions = es.all([headerOptions, {
              props: pick_default()(header, Object.keys(TableHeaderColumn.props))
            }, {
              attrs: omit_default()(header, Object.keys(TableHeaderColumn.props))
            }]);
          } else {
    ...
    createDataColumn: function createDataColumn(column, record) {
      if (column.tag === 'td') {
        var dataOptions = es.all([omit_default()(column.data, 'attrs'), {
          attrs: omit_default.a.apply(void 0, [column.data.attrs].concat(_toConsumableArray(Object.keys(TableDataColumn.props)), _toConsumableArray(Object.keys(TableHeaderColumn.props))))
        }, {
          props: _objectSpread({}, pick_default.a.apply(void 0, [this.$props].concat(_toConsumableArray(Object.keys(TableDataColumn.props)))), pick_default.a.apply(void 0, [column.data.attrs].concat(_toConsumableArray(Object.keys(TableDataColumn.props)))), {
            record: record
          })
        }]);
        return this.$createElement(TableDataColumn, dataOptions, column.children);
      }
    },
    createDataRow: function createDataRow(columns, record) {
      var _this = this;

      var dataColumns = columns.map(function (column) {
        return _this.createDataColumn(column, record);
      });
      var rowOptions;

      if (typeof this.row === 'function') {
        rowOptions = {
          attrs: this.row(record)
        };
      } else {
        rowOptions = {
          attrs: this.row
  ...
  render: function render(createElement) {
    ...
    var columns, headerColumns, dataRows, footer;
    var scopedSlot = this.$scopedSlots.default;

    if (scopedSlot) {
      var _scopedSlot;

      var proxyHash = new Proxy({}, {
        get: function get() {
          return '';
        }
      });
      columns = flattenDeep_default()(scopedSlot((_scopedSlot = {}, _defineProperty(_scopedSlot, this.recordVariable, proxyHash), _defineProperty(_scopedSlot, "table", this), _scopedSlot)));
      headerColumns = columns.map(this.createHeaderColumn);
      dataRows = this.$props.records.map(function (record) {
        var _scopedSlot2;

        columns = flattenDeep_default()(scopedSlot((_scopedSlot2 = {}, _defineProperty(_scopedSlot2, _this2.recordVariable, record), _defineProperty(_scopedSlot2, "table", _this2), _scopedSlot2)));
        return _this2.createDataRow(columns, record);
      });
    } else {
    ...
    var header = createElement('thead', [createElement('tr', headerColumns)]); // let body = this.renderFirstSlotOrChildrenWithHooks({ slotName: 'body', tag: 'tbody', children: dataRows })

    var body = createElement('tbody', dataRows);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"520dc496-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/PaginationLinks.vue?vue&type=template&id=1d5ff66d&
var PaginationLinksvue_type_template_id_1d5ff66d_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{attrs:{"aria-label":"Page navigation","align":"right"}},[_c('ul',{staticClass:"pagination"},[_c('li',{class:{ disabled: _vm.currentPage === 1 }},[_c('a',{attrs:{"href":"#","aria-label":"Previous"},on:{"click":function($event){$event.preventDefault();_vm.setPage(_vm.currentPage - 1, $event)}}},[_c('span',{attrs:{"aria-hidden":"true"}},[_vm._v("«")])])]),_vm._l((_vm.windowedPageNumbers()),function(i){return _c('li',{key:("page-" + i),class:{ active: i === _vm.currentPage}},[(i === 'gap')?_c('span',{staticClass:"gap"},[_vm._v("…")]):_c('a',{attrs:{"href":"#"},on:{"click":function($event){$event.preventDefault();_vm.setPage(i, $event)}}},[_vm._v(_vm._s(i))])])}),_c('li',{class:{ disabled: _vm.currentPage === _vm.totalPages }},[_c('a',{attrs:{"href":"#","aria-label":"Next"},on:{"click":function($event){$event.preventDefault();_vm.setPage(_vm.currentPage + 1, $event)}}},[_c('span',{attrs:{"aria-hidden":"true"}},[_vm._v("»")])])])],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/PaginationLinks.vue?vue&type=template&id=1d5ff66d&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/PaginationLinks.vue?vue&type=script&lang=js&
...
/* harmony default export */ var PaginationLinksvue_type_script_lang_js_ = ({
  props: {
  ...
  methods: {
    ...
    windowedPageNumbers: function windowedPageNumbers() {
      ...
      middle = range_default()(windowFrom, windowTo + 1); // left window

      if (this.paginationOuterWindow + 3 < middle[0]) {
        // there's a pagination gap
        left = range_default()(1, this.paginationOuterWindow + 2);
        left.push('gap');
      } else {
        // runs into visible pages
        left = range_default()(1, middle[0]);
      } // right window


      if (this.totalPages - this.paginationOuterWindow - 2 > middle[middle.length - 1]) {
        // again, gap
        right = range_default()(this.totalPages - this.paginationOuterWindow, this.totalPages + 1);
        right.unshift('gap');
      } else {
        // runs into visible pages
        right = range_default()(middle[middle.length - 1] + 1, this.totalPages + 1);
      }
...
// CONCATENATED MODULE: ./src/components/PaginationLinks.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_PaginationLinksvue_type_script_lang_js_ = (PaginationLinksvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/components/PaginationLinks.vue
...
var component = normalizeComponent(
  components_PaginationLinksvue_type_script_lang_js_,
  PaginationLinksvue_type_template_id_1d5ff66d_render,
  staticRenderFns,
  false,
  null,
  null,
...
component.options.__file = "PaginationLinks.vue"
/* harmony default export */ var PaginationLinks = (component.exports);
// EXTERNAL MODULE: ./node_modules/lodash/flatten.js
var flatten = __webpack_require__("4d8c");
var flatten_default = /*#__PURE__*/__webpack_require__.n(flatten);

// CONCATENATED MODULE: ./src/components/PaginatedTableFor.js
...
/* harmony default export */ var PaginatedTableFor = ({
  components: {
    TableFor: TableFor,
    PaginationLinks: PaginationLinks
  },
  props: _objectSpread({}, TableFor.props, PaginationLinks.props),
  methods: {
    handleUpdatePage: function handleUpdatePage(page) {
  ...
  render: function render(createElement) {
    ...
    var mapSlotsToChildren = function mapSlotsToChildren(slots, createElement) {
      return flatten_default()(Object.values(slots)).map(function (slot) {
    ...
    if (!scopedSlots.footer && !this.$slots.footer) {
      footer = function footer(props) {
        return createElement('tfoot', [createElement('tr', [createElement('td', {
          attrs: {
          ...
          props: _this.$props,
          on: {
            'update:currentPage': _this.handleUpdatePage
          }
        })])])]);
      };
    }

    return createElement(TableFor, {
...
// CONCATENATED MODULE: ./src/components/LocalPaginatedTableFor.js
...
/* harmony default export */ var LocalPaginatedTableFor = ({
  components: {
    PaginatedTableFor: PaginatedTableFor
  },
  props: _objectSpread({}, omit_default()(PaginatedTableFor.props, ['currentPage', 'totalPages']), {
    perPage: {
      type: Number,
      default: 10
    }
  ...
  render: function render(createElement) {
    ...
    return createElement(PaginatedTableFor, {
      ...
      attrs: this.$attrs,
      on: {
        'update:currentPage': this.handleUpdatePage
      }
    }, _toConsumableArray(mapSlotsToChildren(this.$slots, createElement)));
  }
});
...
/* harmony default export */ var src_plugin = ({
  install: function install(Vue) {
    ...
    Vue.component('LocalPaginatedTableFor', LocalPaginatedTableFor); // Vue.component('TableDataColumn', TableDataColumn)
...
/******/ });
//# sourceMappingURL=vue-table-for.common.js.map